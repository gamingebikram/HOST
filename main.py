...
TOKEN = os.getenv('8417910138:AAFwIVQExxmZPgjIM06n0NOhyEfHX8ljC9E')
OWNER_ID_STR = os.getenv('7615740556')
ADMIN_ID_STR = os.getenv('7615740556')
gamingebikram = os.getenv('gamingebikram')
UPDATE_CHANNEL = os.getenv('@attack_love')
...
gamingebikram = gamingebikram or '@gamingebikram'
UPDATE_CHANNEL = UPDATE_CHANNEL or 'https://t.me/attack_love'
    ...
    if user_id in admin_ids:
        keyboard = InlineKeyboardMarkup(inline_keyboard=[
            ...
            [InlineKeyboardButton(text="👨‍💼 Admin Panel", callback_data="admin_panel"),
             InlineKeyboardButton(text="💬 Contact", url=f"https://t.me/{gamingebikram.replace('@', '')}")]
        ])
    else:
        keyboard = InlineKeyboardMarkup(inline_keyboard=[
            ...
            [InlineKeyboardButton(text="🎯 Features", callback_data="all_features"),
             InlineKeyboardButton(text="💬 Contact Owner", url=f"https://t.me/{gamingebikram.replace('@', '')}")]
        ])
    return keyboard
